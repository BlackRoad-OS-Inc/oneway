...
- Deploy oneway to Gematria (DO nyc3) with systemd auto-start
...
- Add NLP intent routing: 'add domain' / 'check cert'
- Create OneWay Agent persona with RoundTrip auto-chat
- Integrate with RoadMem for persistent state across restarts
- Add Codex solution entries for common oneway operations
- Build blackroad-operator CLI commands: `br oneway status|deploy|logs`
...
- Contribute BlackRoad improvements back to upstream Caddy v2
